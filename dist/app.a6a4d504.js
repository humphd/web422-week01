...
function init() {
  ...
  var main = document.querySelector('main'); // Load all users from web API as JSON and process into DOM nodes

  users.load() // We have to wait for the fetch() response's Promise to complete
  .then(function (users) {
